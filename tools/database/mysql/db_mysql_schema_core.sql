...
-- MySQL 无 PostgreSQL 扩展机制（PostGIS / pgvector 等不适用，相关能力使用 MySQL 原生类型），GiST 空间索引不适用
...
(
    ...
    `label_key`      VARCHAR(255)  NOT NULL DEFAULT '' COMMENT '多语言文本',
    `label_group`    VARCHAR(255)  NOT NULL DEFAULT '' COMMENT '多语言文本分组',
...
(
    ...
    `root_ind`               SMALLINT     NOT NULL DEFAULT 0 COMMENT '是否顶层租户，顶层租户拥有最大的权限',
    `description`            VARCHAR(255) NOT NULL DEFAULT '' COMMENT '备注说明',
    `status`                 SMALLINT     NOT NULL DEFAULT 1 COMMENT '状态',
    `source`                 SMALLINT     NOT NULL DEFAULT 2 COMMENT '来源',
    `version`                BIGINT       NOT NULL DEFAULT 0 COMMENT '版本号',
...
(
    ...
    `authority_role_type`  VARCHAR(500) NOT NULL DEFAULT '' COMMENT '权限角色类型',
    `status`               SMALLINT     NOT NULL DEFAULT 1 COMMENT '状态',
    `source`               SMALLINT     NOT NULL DEFAULT 2 COMMENT '来源',
    `version`              BIGINT       NOT NULL DEFAULT 0 COMMENT '版本号',
    `active`               SMALLINT     NOT NULL DEFAULT 1 COMMENT '启用状态',
...
(
    ...
    `title`       VARCHAR(150)  NOT NULL DEFAULT '' COMMENT '标题',
    `label`       VARCHAR(150)  NOT NULL DEFAULT '' COMMENT '内容',
    `privilege`   VARCHAR(1000) NOT NULL DEFAULT '' COMMENT '特权',
    `default_ind` SMALLINT      NOT NULL DEFAULT 0 COMMENT '是否默认',
    `trial_ind`   SMALLINT      NOT NULL DEFAULT 0 COMMENT '是否允许试用',
...
(
    ...
    `automatic_renewal_ind` SMALLINT       NOT NULL DEFAULT 0 COMMENT '是否自动续费',
...
(
    ...
    `entity_id`         BIGINT       NOT NULL DEFAULT 0 COMMENT '实体ID',
    `package_id`        BIGINT       NOT NULL DEFAULT 0 COMMENT '套餐ID',
    `trial_start_date`  DATETIME     NULL COMMENT '会员试用开始时间',
    `trial_end_date`    DATETIME     NULL COMMENT '会员试用结束时间',
    `registration_date` DATETIME     NULL COMMENT '会员注册时间',
    `expiration_date`   DATETIME     NULL COMMENT '会员到期时间',
    `description`       VARCHAR(255) NOT NULL DEFAULT '' COMMENT '备注说明',
    `version`           BIGINT       NOT NULL DEFAULT 0 COMMENT '版本号',
    `active`            SMALLINT     NOT NULL DEFAULT 1 COMMENT '启用状态',
    `created_by`        BIGINT       NOT NULL DEFAULT 0 COMMENT '创建人',
...
(
    ...
    `group_type`      VARCHAR(100) NOT NULL DEFAULT '' COMMENT '分组类型',
    `default_ind`     SMALLINT     NOT NULL DEFAULT 0 COMMENT '是否为默认角色',
    `description`     VARCHAR(255) NOT NULL DEFAULT '' COMMENT '备注',
    `status`          SMALLINT     NOT NULL DEFAULT 1 COMMENT '状态',
    `source`          SMALLINT     NOT NULL DEFAULT 2 COMMENT '来源',
    `version`         BIGINT       NOT NULL DEFAULT 0 COMMENT '版本号',
...
(
    ...
    `title`       VARCHAR(150) NOT NULL DEFAULT '' COMMENT '标题',
    `root_ind`    SMALLINT     NOT NULL DEFAULT 0 COMMENT '是否顶层',
    `default_ind` SMALLINT     NOT NULL DEFAULT 0 COMMENT '是否默认',
    `description` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '备注',
    `status`      SMALLINT     NOT NULL DEFAULT 1 COMMENT '状态',
    `source`      SMALLINT     NOT NULL DEFAULT 2 COMMENT '来源',
...
(
    ...
    `sex`                  VARCHAR(20)  NOT NULL DEFAULT 'M' COMMENT '性别',
...
(
    ...
    `success`              SMALLINT      NOT NULL DEFAULT 1 COMMENT '是否成功登录',
    `version`              BIGINT        NOT NULL DEFAULT 0 COMMENT '版本号',
    `active`               SMALLINT      NOT NULL DEFAULT 1 COMMENT '启用状态',
    `created_by`           BIGINT        NOT NULL DEFAULT 0 COMMENT '创建人',
    `created_at`           DATETIME      NOT NULL DEFAULT NOW() COMMENT '创建时间',
...
(
    ...
    `source`              SMALLINT      NOT NULL DEFAULT 2 COMMENT '数据来源',
    `version`             BIGINT        NOT NULL DEFAULT 0 COMMENT '版本号',
    `active`              SMALLINT      NOT NULL DEFAULT 1 COMMENT '启用状态',
    `created_by`          BIGINT        NOT NULL DEFAULT 0 COMMENT '创建人',
    `created_at`          DATETIME      NOT NULL DEFAULT NOW() COMMENT '创建时间',
...
(
    ...
    `label`       VARCHAR(250) NOT NULL DEFAULT '' COMMENT '文本',
    `description` VARCHAR(250) NOT NULL DEFAULT '' COMMENT '备注',
    `default_ind` SMALLINT     NOT NULL DEFAULT 0 COMMENT '默认语言',
    `version`     BIGINT       NOT NULL DEFAULT 0 COMMENT '版本号',
    `active`      SMALLINT     NOT NULL DEFAULT 1 COMMENT '启用状态',
    `created_by`  BIGINT       NOT NULL DEFAULT 0 COMMENT '创建人',
    `created_at`  DATETIME     NOT NULL DEFAULT NOW() COMMENT '创建时间'
...
(
    `id`               BIGINT        NOT NULL PRIMARY KEY AUTO_INCREMENT COMMENT 'ID',
    `label_group_type` VARCHAR(100)  NOT NULL DEFAULT '' COMMENT '多语言分组',
    `code`             VARCHAR(255)  NOT NULL DEFAULT '' COMMENT '多语言标识',
    `zh_cn_label`      VARCHAR(2000) NOT NULL DEFAULT '' COMMENT '简体中文',
    `zh_cn_static_ind` SMALLINT      NOT NULL DEFAULT 0 COMMENT '是否静态文本',
    `zh_tw_label`      VARCHAR(2000) NOT NULL DEFAULT '' COMMENT '繁体中文',
    `zh_tw_static_ind` SMALLINT      NOT NULL DEFAULT 0 COMMENT '是否静态文本',
    `en_label`         VARCHAR(2000) NOT NULL DEFAULT '' COMMENT '英语',
    `en_static_ind`    SMALLINT      NOT NULL DEFAULT 0 COMMENT '是否静态文本',
    `ja_label`         VARCHAR(2000) NOT NULL DEFAULT '' COMMENT '日语',
    `ja_static_ind`    SMALLINT      NOT NULL DEFAULT 0 COMMENT '是否静态文本',
    `kr_label`         VARCHAR(2000) NOT NULL DEFAULT '' COMMENT '韩语',
    `kr_static_ind`    SMALLINT      NOT NULL DEFAULT 0 COMMENT '是否静态文本',
    `fr_label`         VARCHAR(2000) NOT NULL DEFAULT '' COMMENT '法语',
    `fr_static_ind`    SMALLINT      NOT NULL DEFAULT 0 COMMENT '是否静态文本',
...
(
    `id`         BIGINT       NOT NULL PRIMARY KEY AUTO_INCREMENT COMMENT 'ID',
    `path`       VARCHAR(250) NULL COMMENT '路径',
    `start_time` DATETIME     NULL COMMENT '开始时间',
    `end_time`   DATETIME     NULL COMMENT '结束时间',
    `exec_time`  BIGINT       NULL COMMENT '执行时长',
    `version`    BIGINT       NOT NULL DEFAULT 0 COMMENT '版本号',
    `active`     SMALLINT     NOT NULL DEFAULT 1 COMMENT '启用状态',
    `created_by` BIGINT       NOT NULL DEFAULT 0 COMMENT '创建人',
    `created_at` DATETIME     NOT NULL DEFAULT NOW() COMMENT '创建时间'
...
(
    ...
    `client_name`    VARCHAR(150)  NOT NULL DEFAULT '' COMMENT '客户端名称',
    `client_version` VARCHAR(150)  NOT NULL DEFAULT '' COMMENT '客户端版本',
    `details`        VARCHAR(250)  NULL COMMENT '详情',
    `exception`      TEXT          NULL COMMENT '异常',
    `success`        SMALLINT      NOT NULL DEFAULT 1 COMMENT '登录状态',
    `version`        BIGINT        NOT NULL DEFAULT 0 COMMENT '版本号',
    `active`         SMALLINT      NOT NULL DEFAULT 1 COMMENT '启用状态',
    `created_by`     BIGINT        NOT NULL DEFAULT 0 COMMENT '创建人',
    `created_at`     DATETIME      NOT NULL DEFAULT NOW() COMMENT '创建时间'
...
(
    ...
    `request_ua`      TEXT         NULL COMMENT '请求UA',
    `request_uri`     TEXT         NULL COMMENT '请求地址',
    `request_params`  TEXT         NULL COMMENT '请求参数',
    `request_headers` TEXT         NULL COMMENT '请求头',
    `start_time`      DATETIME     NULL COMMENT '开始时间',
    `end_time`        DATETIME     NULL COMMENT '结束时间',
    `exec_time`       BIGINT       NOT NULL DEFAULT 0 COMMENT '执行时长',
    `details`         VARCHAR(250) NULL COMMENT '详情',
    `exception`       TEXT         NULL COMMENT '异常',
    `version`         BIGINT       NOT NULL DEFAULT 0 COMMENT '版本号',
    `active`          SMALLINT     NOT NULL DEFAULT 1 COMMENT '启用状态',
...
(
    `id`          BIGINT       NOT NULL PRIMARY KEY AUTO_INCREMENT COMMENT 'ID',
    `tenant_id`   BIGINT       NOT NULL DEFAULT 0 COMMENT '租户ID',
    `class_name`  VARCHAR(250) NULL COMMENT '类名',
    `method_name` VARCHAR(250) NULL COMMENT '方法名',
    `request_id`  VARCHAR(250) NULL COMMENT '请求ID',
    `details`     VARCHAR(250) NULL COMMENT '详情',
    `exception`   TEXT         NULL COMMENT '异常',
    `version`     BIGINT       NOT NULL DEFAULT 0 COMMENT '版本号',
    `active`      SMALLINT     NOT NULL DEFAULT 1 COMMENT '启用状态',
...
(
    ...
    `mobile_number`       VARCHAR(150) NOT NULL DEFAULT '' COMMENT '手机号码',
    `version`             BIGINT       NOT NULL DEFAULT 0 COMMENT '版本号',
    `active`              SMALLINT     NOT NULL DEFAULT 1 COMMENT '启用状态',
    `created_by`          BIGINT       NOT NULL DEFAULT 0 COMMENT '创建人',
    `created_at`          DATETIME     NOT NULL DEFAULT NOW() COMMENT '创建时间'
...
(
    ...
    `content`              TEXT         NULL COMMENT '内容',
    `data`                 TEXT         NULL COMMENT '数据，一般保存JSON格式的参数',
    `url`                  VARCHAR(255) NOT NULL DEFAULT '' COMMENT '链接',
    `target_sent_datetime` DATETIME     NULL COMMENT '目标发送时间',
    `sent_datetime`        DATETIME     NULL COMMENT '发送时间',
    `attempt`              SMALLINT     NULL COMMENT '尝试发送次数',
    `status`               SMALLINT     NOT NULL DEFAULT 1 COMMENT '发布状态',
    `version`              BIGINT       NOT NULL DEFAULT 0 COMMENT '版本号',
    `active`               SMALLINT     NOT NULL DEFAULT 1 COMMENT '启用状态',
    `created_by`           BIGINT       NOT NULL DEFAULT 0 COMMENT '创建人',
...
(
    ...
    `user_type`           SMALLINT     NOT NULL DEFAULT 0 COMMENT '实体类型',
    `user_id`             BIGINT       NOT NULL DEFAULT 0 COMMENT '实体ID',
    `display_name`        VARCHAR(255) NULL COMMENT '姓名',
...
(
    ...
    `resp`            TEXT         NULL COMMENT '响应内容',
    `exception`       TEXT         NULL COMMENT '异常内容',
    `sent_datetime`   DATETIME     NULL COMMENT '发送时间',
    `status`          SMALLINT     NOT NULL DEFAULT 1 COMMENT '发布状态',
    `version`         BIGINT       NOT NULL DEFAULT 0 COMMENT '版本号',
    `active`          SMALLINT     NOT NULL DEFAULT 1 COMMENT '启用状态',
...
(
    ...
    `allow_comment_ind` SMALLINT     NOT NULL DEFAULT 1 COMMENT '是否允许评论',
    `description`       VARCHAR(255) NOT NULL DEFAULT '' COMMENT '备注',
    `version`           BIGINT       NOT NULL DEFAULT 0 COMMENT '版本号',
    `active`            SMALLINT     NOT NULL DEFAULT 1 COMMENT '启用状态',
    `created_by`        BIGINT       NOT NULL DEFAULT 0 COMMENT '创建人',
...
(
    ...
    `wkb_geometry`       GEOMETRY     NULL COMMENT '空间几何边界',
    `version`            BIGINT       NOT NULL DEFAULT 0 COMMENT '版本号',
    `active`             SMALLINT     NOT NULL DEFAULT 1 COMMENT '启用状态',
    `created_by`         BIGINT       NOT NULL DEFAULT 0 COMMENT '创建人',
    `created_at`         DATETIME     NOT NULL DEFAULT NOW() COMMENT '创建时间',
...
-- PostgreSQL GiST 空间索引 MySQL 不支持，已忽略（sys_region.wkb_geometry）
...
(
    ...
    `title`       VARCHAR(150) NOT NULL DEFAULT '' COMMENT '地点标题',
...
(
    ...
    `client_id_issued_at`           DATETIME      NULL COMMENT '客户端ID签发时间',
    `client_secret`                 VARCHAR(255)  NOT NULL DEFAULT '' COMMENT 'Client Secret',
    `client_secret_expires_at`      DATETIME      NULL COMMENT '客户端密钥过期时间',
...
(
    ...
    `principal_name`                VARCHAR(200)  NULL COMMENT '主体名称',
    `authorization_grant_type`      VARCHAR(100)  NULL COMMENT '授权类型',
    `attributes`                    TEXT          NULL COMMENT '属性',
    `state`                         VARCHAR(2000) NULL COMMENT '状态',
    `authorization_code_value`      VARCHAR(2000) NULL COMMENT '授权码值',
    `authorization_code_issued_at`  DATETIME      NULL COMMENT '授权码签发时间',
    `authorization_code_expires_at` DATETIME      NULL COMMENT '授权码过期时间',
    `authorization_code_metadata`   TEXT          NULL COMMENT '授权码元数据',
    `access_token_value`            TEXT          NULL COMMENT '访问令牌值',
    `access_token_issued_at`        DATETIME      NULL COMMENT '访问令牌签发时间',
    `access_token_expires_at`       DATETIME      NULL COMMENT '访问令牌过期时间',
    `access_token_metadata`         TEXT          NULL COMMENT '访问令牌元数据',
    `access_token_type`             VARCHAR(100)  NULL COMMENT '访问令牌类型',
    `access_token_scopes`           VARCHAR(2000) NULL COMMENT '访问令牌范围',
    `oidc_id_token_value`           TEXT          NULL COMMENT 'OIDC ID令牌值',
    `oidc_id_token_issued_at`       DATETIME      NULL COMMENT 'OIDC ID令牌签发时间',
    `oidc_id_token_expires_at`      DATETIME      NULL COMMENT 'OIDC ID令牌过期时间',
    `oidc_id_token_metadata`        TEXT          NULL COMMENT 'OIDC ID令牌元数据',
    `oidc_id_token_claims`          TEXT          NULL COMMENT 'OIDC ID令牌声明',
    `refresh_token_value`           TEXT          NULL COMMENT '刷新令牌值',
    `refresh_token_issued_at`       DATETIME      NULL COMMENT '刷新令牌签发时间',
    `refresh_token_expires_at`      DATETIME      NULL COMMENT '刷新令牌过期时间',
    `refresh_token_metadata`        TEXT          NULL COMMENT '刷新令牌元数据',
    `version`                       BIGINT        NOT NULL DEFAULT 0 COMMENT '版本号',
    `active`                        SMALLINT      NOT NULL DEFAULT 1 COMMENT '启用状态',
    `created_by`                    BIGINT        NOT NULL DEFAULT 0 COMMENT '创建人',
    `created_at`                    DATETIME      NOT NULL DEFAULT NOW() COMMENT '创建时间',
...
(
    ...
    `last_message_id` BIGINT       NOT NULL DEFAULT 0 COMMENT '最新消息的ID',
...
(
    ...
    `last_read_at`         DATETIME NULL COMMENT '最后读取消息事件',
    `top_ind`              SMALLINT NOT NULL DEFAULT 0 COMMENT '是否置顶',
    `top_at`               DATETIME NULL COMMENT '置顶时间',
    `collect_ind`          SMALLINT NOT NULL DEFAULT 0 COMMENT '是否收藏',
    `collect_at`           DATETIME NULL COMMENT '收藏时间',
    `clear_ind`            SMALLINT NOT NULL DEFAULT 0 COMMENT '是否清除',
...
(
    ...
    `sender_user_type`     VARCHAR(100) NOT NULL DEFAULT '' COMMENT '发送人用户类型',
    `receiver_user_id`     BIGINT       NOT NULL DEFAULT 0 COMMENT '接收人ID',
    `receiver_user_type`   VARCHAR(100) NOT NULL DEFAULT '' COMMENT '接收人用户类型',
...
(
    ...
    `greeting`      VARCHAR(255)  NOT NULL DEFAULT '' COMMENT '问候语',
...
(
    ...
    `details`              VARCHAR(255)   NOT NULL DEFAULT '' COMMENT '描述',
    `description`          VARCHAR(255)   NOT NULL DEFAULT '' COMMENT '备注说明',
    `collection_name`      VARCHAR(255)   NOT NULL DEFAULT '' COMMENT '向量集合名称',
    `top_k`                INT            NOT NULL DEFAULT 0 COMMENT '单次召回数量',
    `similarity_threshold` DECIMAL(10, 2) NOT NULL DEFAULT 0 COMMENT '相似度阈值',
    `chunk_size`           DECIMAL(10, 2) NOT NULL DEFAULT 1024 COMMENT '分片大小',
    `chunk_overlap`        DECIMAL(10, 2) NOT NULL DEFAULT 256 COMMENT '分片重叠',
...
(
    ...
    `biz_type`        VARCHAR(100) NOT NULL DEFAULT '' COMMENT '业务类型',
    `title`           VARCHAR(100) NOT NULL DEFAULT '' COMMENT '标题',
    `content`         TEXT         NULL COMMENT '分片文本内容',
    `content_type`    VARCHAR(100) NOT NULL DEFAULT '' COMMENT '内容类型',
    `content_size`    BIGINT       NOT NULL DEFAULT 0 COMMENT '分片文本大小（字符/字节）',
    `content_hash`    VARCHAR(255) NOT NULL DEFAULT '' COMMENT '内容哈希，用于去重或变更检测',
    `chunk_index`     INT          NOT NULL DEFAULT 0 COMMENT '分片序号（同一文档内从0递增）',
    `chunk_total`     INT          NOT NULL DEFAULT 0 COMMENT '所属文档总分片数',
    `chunk_strategy`  VARCHAR(100) NOT NULL DEFAULT '' COMMENT '切分策略（token/character/recursive/markdown/sentence）',
    `start_index`     INT          NOT NULL DEFAULT 0 COMMENT '分片在原文中的起始位置',
    `end_index`       INT          NOT NULL DEFAULT 0 COMMENT '分片在原文中的结束位置',
    `embedding_model` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '生成向量的嵌入模型标识',
    `vector_doc_id`   VARCHAR(255) NOT NULL DEFAULT '' COMMENT '向量库中对应的向量文档ID（ES 向量集合内）',
    `vectorized`      SMALLINT     NOT NULL DEFAULT 0 COMMENT '是否已向量化入库',
    `metadata`        TEXT         NULL COMMENT '分片元数据',
    `status`          SMALLINT     NOT NULL DEFAULT 1 COMMENT '状态',
    `version`         BIGINT       NOT NULL DEFAULT 0 COMMENT '版本号',
    `active`          SMALLINT     NOT NULL DEFAULT 1 COMMENT '启用状态',
    `created_by`      BIGINT       NOT NULL DEFAULT 0 COMMENT '创建人',
...
(
    ...
    `tenant_id`   BIGINT       NOT NULL DEFAULT 0 COMMENT '租户ID',
    `kb_id`       BIGINT       NOT NULL DEFAULT 0 COMMENT '知识库ID',
    `kb_item_id`  BIGINT       NOT NULL DEFAULT 0 COMMENT '知识条目ID',
    `task_id`     VARCHAR(150) NOT NULL DEFAULT '' COMMENT '任务标识',
    `task_type`   VARCHAR(50)  NOT NULL DEFAULT '' COMMENT '任务类型（ITEM/REBUILD）',
    `progress`    INT          NOT NULL DEFAULT 0 COMMENT '进度',
    `token_usage` BIGINT       NOT NULL DEFAULT 0 COMMENT '消耗词元',
...
(
    ...
    `chat_type`       VARCHAR(100) NOT NULL DEFAULT '' COMMENT '聊天类型',
    `agent_code`      VARCHAR(100) NOT NULL DEFAULT '' COMMENT '智能体编号',
    `version`         BIGINT       NOT NULL DEFAULT 0 COMMENT '版本号',
    `active`          SMALLINT     NOT NULL DEFAULT 1 COMMENT '启用状态',
    `created_by`      BIGINT       NOT NULL DEFAULT 0 COMMENT '创建人',
    `created_at`      DATETIME     NOT NULL DEFAULT NOW() COMMENT '创建时间',
...
(
    ...
    `tenant_id`         BIGINT       NOT NULL DEFAULT 0 COMMENT '租户ID',
    `user_id`           BIGINT       NOT NULL DEFAULT 0 COMMENT '用户ID',
    `usage_type`        VARCHAR(50)  NOT NULL DEFAULT '' COMMENT '用量类型（CHAT/SEARCH/EMBEDDING/RERANK）',
