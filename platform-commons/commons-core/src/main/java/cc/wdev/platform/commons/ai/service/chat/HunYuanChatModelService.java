 ...
 * @author elvea
 */
public class HunYuanChatModelService extends AbstractChatModelService {

    public HunYuanChatModelService(ModelCommonsConfig commonsConfig, ModelChatConfig modelConfig) {
